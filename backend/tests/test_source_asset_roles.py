...
class TestSeedance:
    def test_首尾帧各自带着_role_进_content(self, images) -> None:
        from app.ai.providers.video.seedance import build_submit_payload
...
class TestKling:
    def test_尾帧走_image_tail(self, images) -> None:
        from app.ai.providers.video.kling import build_submit_payload
...
class TestMiniMax:
    def test_三种角色都进_content(self, images) -> None:
        from app.ai.providers.video.minimax import build_submit_payload

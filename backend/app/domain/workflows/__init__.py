...
NODE_TYPES: dict[str, dict[str, Any]] = {
    ...
    "plugin_tool": {
        ...
        "config": {
            ...
            "instance_id": {"advanced": True, "type": "string", "description": "用哪个连接;留空自动选(仅一个时)", "plugin_instances": True, "depends_on": "plugin_id"},
    ...
    "timeline_append": {
        ...
        "config": {
            ...
            "track_id": {"advanced": True, "type": "template", "description": "接到哪条轨道。留空自动挑一条同类的"},
            "start": {"advanced": True, "type": "number", "description": "从第几秒开始截。留空从头"},
            "end": {"advanced": True, "type": "number", "description": "截到第几秒。留空到尾"},
        },
    ...
    "ai_generate": {
        ...
        "config": {
            ...
            "source_assets": {"type": "template", "description": _source_assets_help()},
        },
    ...
    "json_extract": {
        ...
        "config": {
            ...
            "path": {"type": "template", "description": "点路径,如 data.items.0.title;留空返回整个对象"},
        },
        "outputs": ["value", "text"],
    },
    "text_transform": {
        ...
        "config": {
            ...
            "find": {"type": "template", "description": "replace 的查找串 / regex_extract 的正则"},
            "replace": {"type": "template", "description": "replace 的替换串"},
        },
        "outputs": ["text", "length"],
    },
    "delay": {
    ...
    "translate": {
        ...
        "config": {
            ...
            "profile_id": {"advanced": True, "type": "string", "description": "engine=ai 时的供应商配置,留空自动"},
        },
        "outputs": ["text"],
    },
    "loop_foreach": {
    ...
    "loop_while": {
        ...
        "config": {
            ...
            "max_iterations": {"advanced": True, "type": "number", "description": "最大轮次(默认 50,硬上限 1000),防死循环"},
    ...
    "browser_open": {
        ...
        "config": {
            ...
            "session_name": {"type": "template", "description": "具名会话名称(session_mode=named 时必填)"},
    ...
    "browser_click": {
        ...
        "config": {
            ...
            "exact": {"advanced": True, "type": "string", "options": ["否", "是"], "description": "文本是否精确匹配"},
        },
        "outputs": ["session"],
    },
    "browser_input": {
    ...
    "browser_upload": {
        ...
        "config": {
            "session": {"type": "string", "required": True, "description": "来自「打开浏览器」的 session"},
            "selector": {"advanced": True, "type": "template", "description": "文件输入框 CSS 选择器(默认 input[type=file])"},
            ...
            "timeout_ms": {"advanced": True, "type": "number", "description": "等文件输入框出现的超时(毫秒,默认 15000)"},
        },
        "outputs": ["session"],
    },
    "browser_extract": {
        ...
        "config": {
            ...
            "attribute": {"advanced": True, "type": "template", "description": "取该属性值(留空=取文本)"},
            "all": {"advanced": True, "type": "string", "options": ["否", "是"], "description": "是=取全部匹配为数组;否=第一个"},
        },
    ...
    "browser_scroll": {
        ...
        "config": {
            ...
            "dy": {"advanced": True, "type": "number", "description": "无选择器时向下滚动的像素,默认 600"},
        },
        "outputs": ["session"],
    },
    "browser_evaluate": {

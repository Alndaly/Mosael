...
NODE_TYPES: dict[str, dict[str, Any]] = {
    ...
    "browser_click": {
        ...
        "config": {
            ...
            "exact": {"advanced": True, "type": "string", "options": ["否", "是"], "description": "wfNode_browser_click_exact"},
        },
        "outputs": ["session"],
    },
    "browser_input": {
    ...
    "browser_extract": {
        ...
        "config": {
            ...
            "all": {"advanced": True, "type": "string", "options": ["否", "是"], "description": "wfNode_browser_extract_all"},
        },
    ...
    "browser_wait": {
        ...
        "config": {
            ...
            "gone": {"advanced": True, "type": "string", "options": ["否", "是"], "description": "wfNode_browser_wait_gone"},

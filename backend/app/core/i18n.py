...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "jobMsg_separateQueued": {"zh": "人声伴奏分离排队中", "en": "Voice/accompaniment separation queued"},
    "jobMsg_separateRunning": {"zh": "正在分离人声与伴奏(本机跑模型,长素材会很慢)", "en": "Separating voice and accompaniment (local model; long assets take a while)"},
    "jobMsg_separateDone": {"zh": "分离完成,人声与伴奏已加入素材库", "en": "Separated; the voice and accompaniment stems are in the media library"},

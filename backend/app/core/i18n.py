...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "wfNode_scene_render_board": {"zh": "从 3D 场景的一个镜头渲出首帧、尾帧和运镜视频,给生成当参考", "en": "Render the first frame, last frame and camera move of a 3D shot as references for generation."},

...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "wfField_engine_voice": {"zh": "引擎音色", "en": "Engine voice"},
    ...
    "wfNode_synthesize_speech_voice_id": {"zh": "克隆音色:配音库里那把嗓子。用引擎音色时留空", "en": "A cloned voice from your voice library. Leave empty when using an engine voice"},
    "wfNode_synthesize_speech_engine": {"zh": "引擎音色:用现成的嗓子,不必先克隆。用克隆音色时留空", "en": "Speak in a stock voice — no cloning needed. Leave empty when using a cloned voice"},

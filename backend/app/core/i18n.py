...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "wfNode_denoise_audio_strength": {
        ...
        "en": "How hard to go: light removes only the obvious hiss, medium suits most recordings, strong is the cleanest but can dull the voice. Voice isolation ignores this.",
    },

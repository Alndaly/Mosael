...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "wfNode_dub_subtitles_line": {"zh": "双语字幕念哪一行", "en": "Which line of a bilingual cue to speak"},
    "wfNode_dub_subtitles_original_audio": {
        "zh": "配音之后原声怎么办。「压低」在配音说话时把原声降到 30%,适合原声是环境音或音乐;译配时两边都是人声,压低只会变成两个人同时说话,用「静音」;「只去掉人声」要本机装了分离引擎,没装就整轨静音。都不删东西,随时能改回来。",
        "en": "What happens to the original audio once the dub lands. Lower turns it down to 30% while the dub speaks, which suits ambience or music; a translated dub replaces one voice with another, so lowering leaves two people talking at once — use Mute. Remove the voice needs a separation engine on this machine and mutes the track without one. Nothing is deleted, and it can be changed back at any time.",
    },
    ...
    "wfOpt_line_all": {"zh": "全念", "en": "All lines"},
    "wfOpt_line_first": {"zh": "只念第一行", "en": "First line only"},
    "wfOpt_line_last": {"zh": "只念最后一行", "en": "Last line only"},

...
源码托管在 GitHub:**[Alndaly/OpenStudio](https://github.com/Alndaly/OpenStudio)**。

- 桌面安装包:[GitHub Releases](https://github.com/Alndaly/OpenStudio/releases)(macOS arm64 `.dmg` / Windows x64 安装器,推 tag 后由 CI 自动打包上传)
- 问题反馈 / 功能建议:[GitHub Issues](https://github.com/Alndaly/OpenStudio/issues)
...
Open Studio **源码开放但非开源软件**,采用专有许可(全文见仓库根目录 [LICENSE](https://github.com/Alndaly/OpenStudio/blob/main/LICENSE)):

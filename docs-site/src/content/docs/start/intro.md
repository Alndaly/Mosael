...
![Mibu 首页:工作区总览、近 14 天任务 / 发布 / AI 费用统计与项目列表](../../../assets/screens/home.png)
...
- **数据**:全部落在本机 `~/.mibu-cut`,不依赖云端,离线可用。

## 谁适合用

独立创作者、小团队:想在一处完成从剪辑到多平台分发,还能用 AI 与工作流自动化重复劳动,又不想把素材传上第三方云的人。

源码开放在 [GitHub](https://github.com/Alndaly/mibu-cut)(专有许可,详见[项目信息](/about/project/))。

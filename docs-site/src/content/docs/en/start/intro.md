---
title: What is Open Studio
description: A video studio that folds editing, AI generation, orchestration and publishing into one desktop app.
sidebar:
  order: 1
---

Open Studio is a **local-first desktop app** that folds the four legs of content creation into a single window:
...
The source code is available on [GitHub](https://github.com/Alndaly/OpenStudio) (proprietary license — see [About the project](/en/about/project/)).

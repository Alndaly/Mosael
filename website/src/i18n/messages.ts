...
const zh = {
  ...
  home: {
    ...
    titleLead: "让灵感落进",
    titleAccent: "时间线",
    lede: "一段素材，从构思、整理、剪辑到发布，都在同一个创作空间里完成。Mosael 把无限画布、时间线、智能体和工作流放在一起，让创作少一点切换，多一点连贯。",
    ctaDownload: "下载 macOS 版",
    ctaSource: "在 GitHub 查看",
    platforms: "macOS 12.0+ · Apple Silicon 与 Intel · Windows 10/11 x64",
    heroShotAlt: "Mosael 工作区：逐字稿、播放器、属性面板、AI 智能体与多轨时间线",
    chapters: [
      {
        label: "无限画布",
        title: "自由铺开，随时连接",
...
const en: Messages = {
  ...
  home: {
    eyebrow: "Local-first · Made for creators",
    title: "Where ideas find their timeline",
    titleLead: "Where ideas find their",
    titleAccent: "timeline",
    lede: "Move from a spark to a finished story in one creative space. Mosael brings an infinite canvas, timeline editor, AI agent, and visual workflows together, so your work stays connected from first thought to final export.",
    ctaDownload: "Download for macOS",
    ctaSource: "View on GitHub",
    platforms: "macOS 12.0+ · Apple Silicon & Intel · Windows 10/11 x64",
    heroShotAlt: "The Mosael workspace with transcript, viewer, properties, AI agent, and multi-track timeline",
    chapters: [
      {
    ...
    moreTitle: "Everything you need, nothing you don't.",
    more: [

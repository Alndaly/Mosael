...
export function PageGlow() {
  return (
    <div aria-hidden="true" data-page-glow className="pointer-events-none absolute inset-0 -z-10 [mask-image:linear-gradient(to_bottom,black_30%,transparent_100%)] bg-[radial-gradient(circle_at_12%_18%,rgba(114,87,233,0.16),transparent_32%),radial-gradient(circle_at_88%_0%,rgba(255,139,120,0.14),transparent_28%)] dark:bg-[radial-gradient(circle_at_12%_18%,rgba(114,87,233,0.2),transparent_34%),radial-gradient(circle_at_88%_0%,rgba(255,139,120,0.08),transparent_28%)]" />
  );
}

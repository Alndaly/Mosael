...
Use [3D scenes and animation](/docs/guides/scenes) to test space, lighting and camera movement before handing references to your model. Keep source material in [Notes and knowledge](/docs/guides/notes), then organize document references, comments and markers on an [idea board](/docs/guides/boards).

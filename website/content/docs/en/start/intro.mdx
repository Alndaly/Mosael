...
![Open Studio home: workspace overview, 14-day task / publish / AI cost stats and project list](/media/screens/home.png)
...
The source code is available on [GitHub](https://github.com/Alndaly/OpenStudio) (proprietary license — see [About the project](/en/docs/about/project)).

...
2. Choose your workspace in the app, open Workflows, then use Import to select the file.
...
Use v1.0.0-beta4 or later. Template node names and prompts are currently in Chinese.

...
![Knowledge base: datasets and document list (documents / recall test / knowledge graph / settings)](/media/screens/kb.png)
...
![Demo: create a knowledge base and import a Markdown document](/media/gifs/knowledge-base.gif)

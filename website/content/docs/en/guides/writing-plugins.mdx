...
A plugin is how capability from outside Mosael gets in. Writing one does not mean reading
...
[manifest reference](https://github.com/Alndaly/Moseal/blob/main/docs/PLUGIN_MANIFEST.md)

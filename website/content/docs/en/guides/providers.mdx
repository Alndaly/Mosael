...
![Settings → AI Image: default model + configured provider list](/media/screens/settings-models.png)
...
![Demo: provider configuration entries for AI Chat and AI Image](/media/gifs/providers.gif)

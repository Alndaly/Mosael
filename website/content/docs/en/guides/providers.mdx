...
uploads local reference images through the Evolink Files API, submits the asynchronous task by model
id, then immediately downloads expiring results into the local media library.

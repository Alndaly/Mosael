# Mibu New — 前端彻底重做 + 编辑内核补全(第一版)设计

日期:2026-07-15
状态:已与用户对齐(视觉方向、痛点、交付边界均经确认)
上位计划:`/Users/kinda/Developer/mibu-video/docs/mibu-rewrite-ai-implementation-plan.md`

## 1. 背景与问题

当前 mibu-video 后端已有真实关系模型与 domain 骨架,但前端只是 260 行的脚手架:

...
The current runtime scans manifests, lets users enable plugins, aggregates enabled tools, and records invocations. Actual sandboxed execution adapters come next.

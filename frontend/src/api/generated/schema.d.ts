...
export interface paths {
    ...
    "/api/notifications/read": {
         ...
         * @description 清空自己已读的通知。读过的没有第二次价值,却会把面板一直占满;未读的不动。
         */
    ...
    "/api/scenes/blender/connections": {
        ...
        /** Connections */
        get: operations["connections_api_scenes_blender_connections_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/scenes/blender/connections/{instance_id}/check": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Check */
        post: operations["check_api_scenes_blender_connections__instance_id__check_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/scenes/{scene_id}/blender/{transfer_id}/receive": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/scenes/{scene_id}/blender/{transfer_id}/project": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/workflows/node-types": {
        ...
        /**
         * Node Types
         * @description 节点类型清单,**按面板分组顺序排好**、按请求方的语言翻好(见 domain/workflows/node_catalog)。
         *
    ...
    "/api/workflows/{workflow_id}/revisions": {
        ...
        /** List Revisions */
        get: operations["list_revisions_api_workflows__workflow_id__revisions_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/workflows/{workflow_id}/revisions/{revision}": {
        ...
        /** Get Revision */
        get: operations["get_revision_api_workflows__workflow_id__revisions__revision__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/workflows/{workflow_id}/revisions/{revision}/restore": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Restore Revision */
        post: operations["restore_revision_api_workflows__workflow_id__revisions__revision__restore_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/notes/{note_id}": {
        ...
        post?: never;
        /** Permanently Delete */
        delete: operations["permanently_delete_api_notes__note_id__delete"];
        options?: never;
        head?: never;
        /** Edit */
    ...
    "/api/notes/{note_id}/append": {
        ...
        put?: never;
        /** Append */
        post: operations["append_api_notes__note_id__append_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/notes/{note_id}/revisions/{revision}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Revision Content */
        get: operations["revision_content_api_notes__note_id__revisions__revision__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/notes/{note_id}/restore": {
        ...
        put?: never;
        /** Restore */
        post: operations["restore_api_notes__note_id__restore_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        NoteAppend: {
            ...
            markdown: string;
            /** Sources */
            sources?: components["schemas"]["NoteSource"][];
        };
        /** NoteCreate */
        NoteCreate: {
            /**
...
export interface operations {
    ...
    connections_api_scenes_blender_connections_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    check_api_scenes_blender_connections__instance_id__check_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    history_api_scenes__scene_id__blender_get: {
        parameters: {
            query: {
                workspace_id: string;
            };
    ...
    send_api_scenes__scene_id__blender_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    receive_api_scenes__scene_id__blender__transfer_id__receive_post: {
        parameters: {
            query: {
                workspace_id: string;
    ...
    project_api_scenes__scene_id__blender__transfer_id__project_get: {
        parameters: {
            query: {
                workspace_id: string;
            };
    ...
    list_revisions_api_workflows__workflow_id__revisions_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_revision_api_workflows__workflow_id__revisions__revision__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WorkflowRevisionDetailOut"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    restore_revision_api_workflows__workflow_id__revisions__revision__restore_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    source_message_api_notes_sources_message__message_id__get: {
        parameters: {
            query: {
                workspace_id: string;
            };
    ...
    permanently_delete_api_notes__note_id__delete: {
        parameters: {
            query: {
                workspace_id: string;
                base_revision: number;
    ...
    edit_api_notes__note_id__patch: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    append_api_notes__note_id__append_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NoteAppend"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    revisions_api_notes__note_id__revisions_get: {
        parameters: {
            query: {
                workspace_id: string;
            };
    ...
    revision_content_api_notes__note_id__revisions__revision__get: {
        parameters: {
            query: {
                workspace_id: string;
            };
    ...
    restore_api_notes__note_id__restore_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NoteRestore"];
            };
        };
        responses: {
            /** @description Successful Response */

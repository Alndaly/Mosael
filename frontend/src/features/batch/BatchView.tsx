...
function CreateBatchDialog({
  ...
  return (
    <ModalShell open={open} onOpenChange={(next) => !next && onClose()} title={t("batchCreate")}>
      <div className="grid min-w-0 gap-2.5 [&_textarea]:resize-y [&_textarea]:rounded [&_textarea]:border [&_textarea]:border-border [&_textarea]:bg-secondary [&_textarea]:p-1.5 [&_textarea]:text-[12.5px] [&_textarea]:text-foreground [&_textarea:focus-visible]:border-primary [&_textarea:focus-visible]:outline-none">

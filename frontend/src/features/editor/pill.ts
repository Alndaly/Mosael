 ...
 */
export const PILL =
  "inline-flex h-8 cursor-pointer items-center gap-1.5 rounded-md border border-transparent bg-control px-[9px] text-ui-xs text-muted-foreground transition-[color,border-color,background] duration-150 enabled:hover:bg-secondary enabled:hover:text-foreground disabled:cursor-default disabled:opacity-45 [&_em]:rounded-full [&_em]:bg-[color-mix(in_oklab,currentColor_14%,transparent)] [&_em]:px-[5px] [&_em]:text-ui-2xs [&_em]:not-italic [&_em]:tabular-nums";

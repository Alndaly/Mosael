...
const TERMS_ZH: LegalSection[] = [
  { heading: "1. 协议的接受", body: "创建账户或使用 Mosael(下称「本软件」)即表示你已阅读并同意本协议。若不同意,请勿注册或使用。" },
...
const TERMS_EN: LegalSection[] = [
  { heading: "1. Acceptance", body: "By creating an account or using Mosael (the \"Software\") you confirm that you have read and agree to these terms. Do not register or use the Software if you disagree." },

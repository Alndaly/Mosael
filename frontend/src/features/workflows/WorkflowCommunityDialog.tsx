...
import { Bot, CheckCircle2, Film, Search, Scissors, Video } from "lucide-react";
      ...
      <div className="grid min-h-[430px] md:grid-cols-[310px_minmax(0,1fr)]">
        <div className="border-b border-border/60 p-3 md:border-b-0 md:border-r" role="listbox" aria-label={t("wfCommunityTitle")}>
          <div className="grid gap-2">
            ...
            {filtered.length === 0 && (
              <div className="grid min-h-40 place-items-center rounded-lg border border-dashed border-border px-4 text-center text-ui-sm text-muted-foreground">
                {t("wfCommunityNoResults")}
              </div>
            )}
          </div>
        </div>

...
export function AgentMarkdown({ children }: { children: string }) {
  ...
  return (
    <Streamdown
      className="min-w-0 max-w-full [&_:is(p,ul,ol,table)]:mx-0 [&_:is(p,ul,ol,table)]:mt-0 [&_:is(p,ul,ol,table)]:mb-2.5 [&_:is(p,ul,ol,table):last-child]:mb-0 [&_:is(h1,h2)]:mt-4 [&_:is(h1,h2)]:mb-2 [&_:is(h1,h2)]:text-[15px] [&_:is(h1,h2)]:font-[650] [&_:is(h1,h2)]:tracking-[-0.01em] [&_:is(h3,h4)]:mt-3 [&_:is(h3,h4)]:mb-1.5 [&_:is(h3,h4)]:text-ui-md [&_:is(h3,h4)]:font-[650] [&_:is(h1,h2,h3,h4):first-child]:mt-0 [&_table]:w-full [&_table]:border-collapse [&_table]:text-ui-sm [&_:is(th,td)]:border [&_:is(th,td)]:border-border [&_:is(th,td)]:px-2 [&_:is(th,td)]:py-1.5 [&_:is(th,td)]:text-left [&_th]:bg-secondary [&_th]:font-semibold [&_code]:rounded-sm [&_code]:bg-panel-inset [&_code]:px-1 [&_code]:py-px [&_code]:font-mono [&_code]:text-xs [&_pre_code]:rounded-none [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-[inherit] [&_:is(ul,ol)]:pl-[18px] [&_div:has(>div>table)]:my-2.5 [&_div:has(>div>table)]:rounded-none [&_div:has(>div>table)]:border-0 [&_div:has(>div>table)]:bg-transparent [&_div:has(>div>table)]:p-0 [&_div:has(>pre)]:rounded-none [&_div:has(>pre)]:border-0 [&_div:has(>pre)]:bg-transparent [&_div:has(>pre)]:px-3 [&_div:has(>pre)]:pb-2.5 [&_div:has(>pre)]:pt-2 [&_div:has(>pre)]:text-ui-xs [&_div:has(>div>pre)]:relative [&_div:has(>div>pre)]:my-2.5 [&_div:has(>div>pre)]:rounded-md [&_div:has(>div>pre)]:p-0 [&_div:has(>div>pre)]:gap-0 [&_div:has(>div>pre)]:overflow-hidden [&_div:has(>div>pre)>div:first-child]:h-8 [&_div:has(>div>pre)>div:first-child]:px-3 [&_div:has(>div>pre)>div:first-child]:text-ui-2xs [&_div:has(>div>pre)>div:first-child]:border-b [&_div:has(>div>pre)>div:first-child]:border-border [&_div:has(>div>pre)>div:nth-child(2)]:!absolute [&_div:has(>div>pre)>div:nth-child(2)]:!inset-x-auto [&_div:has(>div>pre)>div:nth-child(2)]:!right-1.5 [&_div:has(>div>pre)>div:nth-child(2)]:!top-0 [&_div:has(>div>pre)>div:nth-child(2)]:!m-0 [&_div:has(>div>pre)>div:nth-child(2)]:!h-8 [&_div:has(>div>pre)>div:nth-child(2)>div]:!border-0 [&_div:has(>div>pre)>div:nth-child(2)>div]:!bg-transparent [&_div:has(>div>pre)>div:nth-child(2)>div]:!p-0 [&_div:has(>div>pre)>div:nth-child(2)>div]:!backdrop-filter-none [&_div:has(>table)]:rounded-none [&_div:has(>table)]:border-0 [&_div:has(>table)]:bg-transparent"

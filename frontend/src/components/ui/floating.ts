...
export const MODAL_SURFACE = "rounded-2xl border border-border bg-popover text-popover-foreground shadow-[var(--shadow-modal)]";
export const MODAL_OVERLAY = "[.is-desktop_&]:[-webkit-app-region:no-drag] fixed inset-0 z-50 bg-[var(--overlay-modal)]";
export const MODAL_TITLE = "m-0 text-xl font-semibold leading-snug tracking-tight break-words";

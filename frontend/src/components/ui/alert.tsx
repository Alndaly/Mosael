...
>(({ className, ...props }, ref) => (
  <h5
    ref={ref}
    className={cn("mb-0.5 text-ui-sm font-semibold leading-tight tracking-tight", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("min-w-0 text-ui-sm leading-relaxed [&_p]:leading-relaxed", className)}
    {...props}
  />
))

...
manifest. The backend speaks your language too — job messages, engine catalogs, and progress
...
| [docs/CONVENTIONS.md](docs/CONVENTIONS.md) | Coding conventions, and the 34 **ratchet tests** the repo enforces on itself |
